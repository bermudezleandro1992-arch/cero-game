...
class CeroEngine {
    ...
    play(playerIdx, cardId) {
        ...
        this._applyPatch(applyEffect({ players: this.players, current: playerIdx, direction: this._direction, drawStack: this._drawStack, pendingTurn: this._pendingTurn }, card, hand.length));
        if (!isWild(card))
